...
{{--    <meta name="description" content="Smart up Crm">--}}
{{--    <meta name="keywords" content="admin template, robust admin template, dashboard template, flat admin template, responsive admin template, web app">--}}
    ...
    <!-- Apple Icons -->
    <link rel="apple-touch-icon" sizes="60x60" href="{{ asset('dashboard/app-assets/images/smart-logo.png') }}">
    <link rel="apple-touch-icon" sizes="76x76" href="{{ asset('dashboard/app-assets/images/smart-logo.png') }}">
    <link rel="apple-touch-icon" sizes="120x120" href="{{ asset('dashboard/app-assets/images/smart-logo.png') }}">
    <link rel="apple-touch-icon" sizes="152x152" href="{{ asset('dashboard/app-assets/images/smart-logo.png') }}">

    <!-- Favicons -->
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('dashboard/app-assets/images/smart-logo.png') }}">
    <link rel="shortcut icon" type="image/png" href="{{ asset('dashboard/app-assets/images/smart-logo.png') }}">
    ...
    <div class="navbar-wrapper">
        <div class="navbar-header">
            <ul class="nav navbar-nav">
                ...
                <li class="nav-item"><a href="{{route('dashboard')}}" class="navbar-brand nav-link"><img alt="SMART UP" src="{{ asset('dashboard/app-assets/images/smart-logo2.png') }}" data-expand="{{ asset('dashboard/app-assets/images/smart-logo2.png') }}" data-collapse="{{ asset('dashboard/app-assets/images/smart-logo2.png') }}" class="brand-logo"></a></li>
